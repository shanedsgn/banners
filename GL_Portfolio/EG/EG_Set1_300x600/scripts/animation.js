...
.to("#child",{duration: 0.6, top: 272, left: -3, opacity:1, ease:"power4.out"},"-=0.5")
...
.to(".copy-build-1", {duration: 0.7, left: 19, opacity:1, stagger: 0.1, ease:"elastic.out(0.4, 0.7)"},"-=0.5")

.to("#milestone1", {duration: 0.7, scale:0.5, opacity:1, stagger: 0.1, force3D:false, ease: "elastic.out(0.9, 0.7)"},"-=0.5")
.to("#milestone2", {duration: 0.4, top:445, left: 85, opacity:1, force3D:false, rotation: "20", ease: "back.out(1)"},"-=0.5")

.to("#cta",{duration: 0.7, left: 15, opacity:1, ease:"elastic.out(0.4, 0.7)"},"-=0")
;
