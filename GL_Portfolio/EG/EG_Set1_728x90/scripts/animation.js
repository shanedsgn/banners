...
.to(".copy-build-1", {duration: 0.7, left: 171, opacity:1, stagger: 0.1, ease:"elastic.out(0.4, 0.7)"},"-=0.9")

.to("#milestone1", {duration: 0.7, scale:0.5, opacity:1, stagger: 0.1, force3D:false, ease: "elastic.out(0.9, 0.7)"},"-=0.5")
.to("#milestone2", {duration: 0.4, top:35, left: 635, opacity:1, force3D:false, rotation: "12", ease: "back.out(1)"},"-=0.5")

.to("#cta",{duration: 0.7, top: 43, opacity:1, ease:"elastic.out(0.4, 0.7)"},"-=0")
;
