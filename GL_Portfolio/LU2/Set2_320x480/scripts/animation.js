...
tl
.to("#top_milestone",{duration: 0.7, top: 0, opacity:1, ease: "elastic.out(0.3, 0.7)"},"-=0.1")
...
.to("#cta",{duration: 0.7, left: 146, opacity:1, ease:"elastic.out(0.4, 0.7)"},"-=0.4")
.to(".money-drops", {duration: 1.7, top:500, opacity:1, stagger: 0.25, force3D:false, ease: "sine.inOut",repeat:2},"-=1.5")
