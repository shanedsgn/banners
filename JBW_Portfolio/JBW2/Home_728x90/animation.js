...
.to(".character1", {duration: 0.5, opacity: 1, repeat:0,x:-21112,ease:SteppedEase.config(29), repeat:1, repeatDelay:0.7, yoyo:true},"-=0")
...
.to(txt1, {duration: 0.35, top:0, ease: Power2.easeIn, opacity:0},"-=0.4")
 ...
 // Birdhouse
.to(".bh_build1", {duration: 3.5, top:62, left:65, ease: Power2.easeIn, opacity:1,},"-=3.4")
.to(".bh_build2", {duration: 3.5, top:3, left:60, ease: Power2.easeIn, opacity:1},"-=3.5")
.to(".bh_build3", {duration: 3.5, top:32, left:90, ease: Power2.easeIn, opacity:1},"-=3.5")
.to(".bh_build4", {duration: 3.5, top:9, left:66, ease: Power2.easeIn, opacity:1},"-=3.5")
.to(".bh_build5", {duration: 3.5, top:3, left:77, ease: Power2.easeIn, opacity:1},"-=3.5")
...
.to(".character3", {duration: 0.3, opacity: 1, repeat:0,x:-11648,ease:SteppedEase.config(16)},"+=0.2")
...
.to(logo, {duration: 0.5, scale:1, left:233, ease: Power2.easeOut, opacity:1},"-=1.4")
.to(darkred_bckg, {duration: 0.5, scale:1, left:220, ease: Power2.easeOut, opacity:1},"-=1.4")
