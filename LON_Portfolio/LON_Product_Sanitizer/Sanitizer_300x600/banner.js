...
window.onload= function(){
	...
	function startAd() {
		...
		function startAnimation(){
			...
			introTimeline.staggerTo(".bubbles", 0.6, {y:0, opacity:1, scale: 1, ease: Elastic.easeOut.config(1, 0.3), force3D:false, transformOrigin:'50% 50%'}, 0.1, "-=0.8");
			...
			introTimeline.to(frame_3, 1.5, {y:-157, alpha: 1, ease: Elastic.easeOut.config(0.8, 0.8)},"+=0.5");

			//takeaway copy
			introTimeline.to(text2a, 0.3, {x:102, y:-20, opacity:1, ease: Power2.easeOut},"-=0.9");
			introTimeline.to(text2b, 0.3, {x:100, y:-19, opacity:1, ease: Power2.easeOut},"-=0.7");
			introTimeline.to(text2c, 0.3, {x:100, y:-17, opacity:1, ease: Power2.easeOut},"-=0.5");
		...
		function handleOver(event){
			...
			TweenLite.to(product, 0.5, {x:0, y:-20, ease: Power2.easeOut,overwrite:true});
