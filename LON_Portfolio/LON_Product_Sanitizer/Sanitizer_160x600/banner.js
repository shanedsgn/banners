...
window.onload= function(){
	...
	function startAd() {
		...
		function startAnimation(){
			...
			introTimeline.to(frame_3, 1.5, {y:-108, alpha: 1, ease: Elastic.easeOut.config(0.8, 0.8)},"+=0.5");
		...
		function handleOver(event){
			...
			TweenLite.to(product, 0.5, {x:0, y:-15, ease: Power2.easeOut,overwrite:true});
