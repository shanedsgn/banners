...
window.onload= function(){
	...
	function startAd() {
		...
		function startAnimation(){
			...
			introTimeline.to(frame_3, 1.5, {y:-177, alpha: 1, ease: Elastic.easeOut.config(0.8, 0.8)},"+=0.5");

			//takeaway copy
			introTimeline.to(text2a, 0.3, {x:102, y:-20, opacity:1, ease: Power2.easeOut},"-=0.9");
			introTimeline.to(text2b, 0.3, {x:100, y:-19, opacity:1, ease: Power2.easeOut},"-=0.8");
			introTimeline.to(text2c, 0.3, {x:100, y:-17, opacity:1, ease: Power2.easeOut},"-=0.7");
			introTimeline.to(text2d, 0.3, {x:100, y:-17, opacity:1, ease: Power2.easeOut},"-=0.6");
