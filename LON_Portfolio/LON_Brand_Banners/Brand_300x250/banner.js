...
window.onload= function(){
	...
	function startAd() {
		...
		function startAnimation(){
			...
			introTimeline.to(frame_3, 1.5, {x: -64, y:-37, scale: 0.83, alpha: 1, ease: Elastic.easeOut.config(0.8, 0.6)},"+=0.5");

			//product image
	 		introTimeline.from(product1, 0.7, {rotation: 150, x:200, opacity:1, ease: Back.easeInOut.config(1.3), force3D:false},"-=1.5");
