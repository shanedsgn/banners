...
window.onload= function(){
	...
	function startAd() {
		...
		function startAnimation(){
			...
			introTimeline.to(frame_3, 1.5, {y:-63, alpha: 1, ease: Elastic.easeOut.config(0.8, 0.8)},"+=0.5");

	 		//product image
	 		introTimeline.from(product1, 0.7, {y:200, opacity:1, ease: Back.easeInOut.config(1.3), force3D:false},"-=1.5");
			introTimeline.from(product2, 0.7, {rotation: -150, x:-200, opacity:1, ease: Back.easeInOut.config(1.3), force3D:false},"-=1.4");
			introTimeline.from(product3, 0.7, {rotation: 150, x:200, opacity:1, ease: Back.easeInOut.config(1.3), force3D:false},"-=1.3");
	 		
	 		//CTA
	 		introTimeline.from(cta, 1, {y:200, alpha: 0, ease: Elastic.easeOut.config(0.8, 0.8), onComplete:addEventListeners},"-=1.4");		
