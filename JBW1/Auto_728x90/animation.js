...
.to("#car_01b", {duration: 0.3, left:180, rotation:-30, transformOrigin:"0px 20px", opacity:1, ease: "elastic.out(0.9, 0.7)"},"+=0.2")
.to("#car_02a", {duration: 0.2, left:-128, ease: Power2.easeIn, opacity:1,},"-=0.3")
...
// Car (Scene 2)
.to("#car_02a", {duration: 1, left:310, ease: "elastic.out(0.9, 0.7)", opacity:1,},"+=0.8")
.to(txt1_a, {duration: 0.3, top:0, opacity:0},"-=1.02")
.to(".character1", {duration: 0.5, opacity: 1, repeat:0,x:-13832,ease:SteppedEase.config(19), repeat:1, repeatDelay:0.5, yoyo:true},"-=0.3")
.to("#car_02b", {duration: 0.5, left: 315, top:35, rotation:50, transformOrigin:"105px 0px", opacity:1, ease: "elastic.out(0.9, 0.7)", repeat:1, repeatDelay:0.8, yoyo:true},"-=1.5")
...
// Car (Scene 3)
.to(car02_wrapper, {duration: 0.5, opacity:1, top:3, left: -293, scale:0.47, ease: "elastic.out(0.8, 0.9)"},"-=0.3")
.to(surprise, {duration: 0.4, scale:1.5, top:-50, ease: Power2.easeOut, opacity:1},"-=0.2")
...
.to(car02_wrapper, {duration: 0.5, opacity:1, top:0, left: -550, ease: Power2.easeOut},"+=1")
...
.to(".character4", {duration: 1, opacity: 1, repeat:0,x:-8008,ease:SteppedEase.config(11)},"-=0.1")
.to(".product-img", {duration: 0.6, top:0, ease: "elastic.out(0.9, 0.6)", opacity:1, stagger: 0.08},"-=0.8")
.to(logo, {duration: 0.5, scale:0.9, left:232, ease: Power2.easeOut, opacity:1},"-=1.4")
.to(darkred_bckg, {duration: 0.5, scale:1, left:212, ease: Power2.easeOut, opacity:1},"-=1.4")
.to(tagline, {duration: 0.6, scale:0.5, top:0, ease: "elastic.out(0.5, 0.3)", opacity:1},"-=1")
