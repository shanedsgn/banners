...
window.onload= function(){
	...
	function startAd() {
		...
		var divider				= document.getElementById("frame4_divider");
		...
		function startAnimation(){
			...
			introTimeline.from(fgrd1_box, 0.5, {y: -700, opacity:1, ease: Elastic.easeOut.config(0.8, 1)}, "-=0");
			introTimeline.from(frame1_animate, 0.9, {rotationX:30, rotationY:-100, x:700, y:-350, opacity:1, ease: Elastic.easeOut.config(0.5, 0.7)}, "-=0.4");	
			introTimeline.to(fridge, 0.5, {opacity:1, ease: Power2.easeOut});
			introTimeline.to(fridgeshadow, 1, {opacity:0.4, ease: Power2.easeOut},"-=1.3");
			...
			introTimeline.fromTo(".fridgey", 0.3, {x:-1}, {x:1, repeat:4, ease:RoughEase.ease.config({strength:10, points:15, template:Linear.easeNone, randomize:false}) , clearProps:"x"}, "-=0.8");
			introTimeline.to(frame1_animate, 0.5, {rotationX:-30, rotationY:50,  x:-400, y:300, opacity:1, ease: Power2.easeIn},"+=1.2");
			...
			introTimeline.to(".smoke",0.8,{opacity: 1, repeat:0,x:-370,ease:SteppedEase.config(5)},"-=2.3");
			introTimeline.to(frame1_smoke, 1, {opacity:0, y:-70, ease: Power4.easeOut},"-=2");
			
			//scene 2 - light bulb
			introTimeline.from(fgrd2_box, 0.5, {y: -700, opacity:1, ease: Elastic.easeOut.config(0.8, 1)}, "-=0.3");
			introTimeline.to(fgrd2_back, 0.3, {opacity:1, ease: Power2.easeOut},"-=0.4");
			introTimeline.from(frame2_animate, 0.9, {rotationX:30, rotationY:-100, x:700, y:-350, opacity:1, ease: Elastic.easeOut.config(0.5, 0.6)}, "-=0.4");	
			...
			introTimeline.from(bulbglow, 0.5, {repeat:2, opacity:1, ease: Power2.easeOut},"-=1");
			introTimeline.to(frame2_animate, 0.5, {rotationX:-30, rotationY:50,  x:-400, y:300, opacity:1, ease: Power2.easeIn},"+=1.2");
			...
			introTimeline.to(".glow",0.3,{opacity: 1, repeat:3, x:-384,ease:SteppedEase.config(3)},"-=3");

			//scene 3 - gas furnace
			introTimeline.from(fgrd3_box, 0.5, {y: -700, opacity:1, ease: Elastic.easeOut.config(0.8, 1)}, "-=0.1");
	 		introTimeline.to(fgrd3_back, 0.3, {opacity:1, ease: Power2.easeOut},"-=0.4");
	 		introTimeline.from(frame3_animate, 0.9, {rotationX:50, rotationY:-100, x:700, y:-350, opacity:1, ease: Elastic.easeOut.config(0.5, 0.6)}, "-=0.6");	
			...
			introTimeline.to(frame3_animate, 0.5, {rotationX:-30, rotationY:50,  x:-400, y:300, opacity:1, ease: Power2.easeIn},"+=1.2");
			...
			//dollar1
			introTimeline.to(dollar1, 0.2, {opacity:1, ease: Power2.easeOut},"-=2.7");
			introTimeline.to(dollar1, 5, {x: 0, y:-200, opacity:1, ease: Power2.easeOut},"-=2.6");
			introTimeline.to(dollar1, 0.2, {opacity:0, ease: Power2.easeOut},"-=2.6");
			
			//dollar2
			introTimeline.to(dollar2, 0.2, {opacity:1, ease: Power2.easeOut},"-=4.8");
			introTimeline.to(dollar2, 5, {x: 0, y:-200, opacity:1, ease: Power2.easeOut},"-=4.7");
			introTimeline.to(dollar2, 0.2, {opacity:0, ease: Power2.easeOut},"-=4");
			
			//dollar3
			introTimeline.to(dollar3, 0.2, {opacity:1, ease: Power2.easeOut},"-=4.8");
			introTimeline.to(dollar3, 5, {x: 0, y:-200, opacity:1, ease: Power2.easeOut},"-=4.7");
			introTimeline.to(dollar3, 0.2, {opacity:0, ease: Power2.easeOut},"-=2.6");

			//scene 4 - heat pump
	 		introTimeline.from(frame4_animate, 0.9, {rotationX:50, rotationY:-100, x:700, y:-350, opacity:1, ease: Elastic.easeOut.config(0.5, 0.6)}, "-=3.4");	
			introTimeline.to(hp, 0.5, {opacity:1, ease: Power2.easeOut});
			introTimeline.to(hpshadow, 1, {opacity:0.3, ease: Power2.easeOut},"-=3.5");
			introTimeline.from(".star1", 0.7, {x:250, y:0, opacity:1, ease: Elastic.easeOut.config(0.6, 0.5)},"-=3.6");
			introTimeline.from(".star2", 0.7, {x:250, y:0, opacity:1, ease: Elastic.easeOut.config(0.6, 0.5)},"-=3.5");
			introTimeline.from(".star3", 0.7, {x:150, y:0, opacity:1, ease: Elastic.easeOut.config(0.6, 0.5)},"-=3.4");
			introTimeline.from(money, 0.7, {x:0, y:50, opacity:0, ease: Elastic.easeOut.config(0.6, 0.5)},"-=3.4");
			introTimeline.from(text4a, 0.7, {x: 0, y:200, alpha:0, ease: Elastic.easeOut.config(0.8, 0.8)},"-=3.5");
			introTimeline.from(text4b, 0.7, {x: 0, y:200, alpha:0, ease: Elastic.easeOut.config(0.8, 0.8)},"-=3.4");
			introTimeline.to(text4bglow, 0.5, {opacity:1, ease: Power2.easeOut},"-=3.3");
			introTimeline.to(text4bglow, 0.5, {opacity:0, ease: Power2.easeOut},"-=3");
			introTimeline.to(divider, 0.5, {height: 44, opacity:1, ease: Power2.easeOut},"-=3.2");
			introTimeline.to(cta, 0.3, {opacity:1, scaleX: 1, scaleY: 1, ease: Back.easeOut.config(1.7)},"-=3");
			introTimeline.to(logo, 0.5, {opacity:1, ease: Power2.easeOut, onComplete:addEventListeners}, "-=3");
		...
		function handleOver(event){
			TweenMax.staggerTo(".star", 0.3, {x:0, y:-4, ease: Power2.easeOut,overwrite:true}, 0.1);
