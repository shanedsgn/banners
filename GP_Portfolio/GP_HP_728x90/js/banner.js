...
window.onload= function(){
	...
	function startAd() {
		...
		function startAnimation(){
			...
			introTimeline.from(frame1_animate, 0.9, {rotationX:30, rotationY:-100, x:700, y:-350, opacity:1, ease: Elastic.easeOut.config(0.6, 0.5)}, "-=0.4");	
			...
			introTimeline.to(".smoke",0.7,{opacity: 1, repeat:0,x:-370,ease:SteppedEase.config(5)},"-=2.3");
			...
			introTimeline.from(frame2_animate, 0.9, {rotationX:30, rotationY:-100, x:700, y:-350, opacity:1, ease: Elastic.easeOut.config(0.6, 0.5)}, "-=0.4");	
			...
			introTimeline.from(fgrd3_box, 0.5, {y: -700, opacity:1, ease: Elastic.easeOut.config(0.8, 1)}, "-=0.1");
	 		...
	 		introTimeline.from(frame3_animate, 0.9, {rotationX:50, rotationY:-100, x:700, y:-350, opacity:1, ease: Elastic.easeOut.config(0.6, 0.5)}, "-=0.6");	
			...
			//scene 4 - heat pump
	 		introTimeline.from(frame4_animate, 0.9, {rotationX:50, rotationY:-100, x:700, y:-350, opacity:1, ease: Elastic.easeOut.config(0.6, 0.5)}, "-=3.4");	
			...
			introTimeline.to(divider, 0.5, {height: 77, opacity:1, ease: Power2.easeOut},"-=3.2");
