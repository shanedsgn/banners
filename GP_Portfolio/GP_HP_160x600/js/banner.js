...
window.onload= function(){
	...
	function startAd() {
		...
		var text1c				= document.getElementById("frame1_text1c");
		...
		var text2c				= document.getElementById("frame2_text2c");
		...
		function startAnimation(){
			...
			introTimeline.from(text1c, 0.7, {x: 0, y:200, alpha:0, ease: Elastic.easeOut.config(0.8, 0.8)},"-=1.1");
			...
			introTimeline.to(text1c, 0.5, {opacity:0, y:200, ease: Power2.easeIn},"-=0.55");
			...
			introTimeline.from(text2c, 0.7, {x: 0, y:200, alpha:0, ease: Elastic.easeOut.config(0.8, 0.8)},"-=1.1");
			introTimeline.to(frame2_animate, 0.5, {rotationX:-30, rotationY:50,  x:-290, y:140, opacity:1, ease: Power2.easeIn},"+=1.2");
			introTimeline.to(text2c, 0.5, {opacity:0, y:200, ease: Power2.easeIn},"-=0.55");
			...
			introTimeline.to(furnaceshadow, 1, {opacity:0.4, ease: Power2.easeOut},"-=1.3");
