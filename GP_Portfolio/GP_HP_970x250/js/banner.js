...
window.onload= function(){
	...
	function startAd() {
		...
		function startAnimation(){
			...
			introTimeline.to(".smoke",0.5,{opacity: 1, repeat:0,x:-1000,ease:SteppedEase.config(5)},"-=2.3");
			...
			introTimeline.to(".glow",0.3,{opacity: 1, repeat:3, x:-948,ease:SteppedEase.config(3)},"-=3");
			...
			introTimeline.to(dollar1, 3, {x: 0, y:-200, opacity:1, ease: Power2.easeOut},"-=2.6");
			introTimeline.to(frame3_sparkleA, 0.5, {opacity:1, ease: Power2.easeOut},"-=2.8");
			introTimeline.to(".character1",0.3,{opacity: 1, repeat:0,x:-1455,ease:SteppedEase.config(5)},"-=2.7");
			introTimeline.to(dollar1, 0.2, {opacity:0, ease: Power2.easeOut},"-=2.6");
			

			//dollar2
			introTimeline.to(dollar2, 0.2, {opacity:1, ease: Power2.easeOut},"-=2.8");
			introTimeline.to(dollar2, 3, {x: 0, y:-200, opacity:1, ease: Power2.easeOut},"-=2.7");
			introTimeline.to(frame3_sparkleB, 0.5, {opacity:1, ease: Power2.easeOut},"-=2.8");
			introTimeline.to(".character2",0.3,{opacity: 1, repeat:0,x:-1455,ease:SteppedEase.config(5)},"-=2.7");
			introTimeline.to(dollar2, 0.2, {opacity:0, ease: Power2.easeOut},"-=2.6");
			
			//dollar3

			introTimeline.to(dollar3, 0.2, {opacity:1, ease: Power2.easeOut},"-=2.8");
			introTimeline.to(dollar3, 3, {x: 0, y:-200, opacity:1, ease: Power2.easeOut},"-=2.7");
			introTimeline.to(frame3_sparkleC, 0.5, {opacity:1, ease: Power2.easeOut},"-=2.8");
			introTimeline.to(".character3",0.3,{opacity: 1, repeat:0,x:-1455,ease:SteppedEase.config(5)},"-=2.7");
			introTimeline.to(dollar3, 0.2, {opacity:0, ease: Power2.easeOut},"-=2.6");

			//scene 4 - heat pump
	 		introTimeline.from(frame4_animate, 0.9, {rotationX:50, rotationY:-100, x:700, y:-350, opacity:1, ease: Elastic.easeOut.config(0.6, 0.5)}, "-=1.3");	
			introTimeline.to(hp, 0.5, {opacity:1, ease: Power2.easeOut});
			introTimeline.to(hpshadow, 1, {opacity:0.3, ease: Power2.easeOut},"-=1.6");
			...
			introTimeline.to(divider, 0.5, {height: 210, opacity:1, ease: Power2.easeOut},"-=0.9");
			introTimeline.to(cta, 0.3, {opacity:1, scaleX: 1, scaleY: 1, ease: Back.easeOut.config(1.7)},"-=0.5");
			introTimeline.to(logo, 0.5, {opacity:1, ease: Power2.easeOut, onComplete:addEventListeners}, "-=0.7");
