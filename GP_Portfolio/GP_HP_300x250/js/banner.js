...
window.onload= function(){
	...
	function startAd() {
		...
		var text3d				= document.getElementById("frame3_text3d");
		...
		function startAnimation(){
			...
			introTimeline.to(fridgeshadow, 1, {opacity:0.3, ease: Power2.easeOut},"-=1.3");
			...
			introTimeline.from(text3d, 0.7, {x: 0, y:200, alpha:0, ease: Elastic.easeOut.config(0.8, 0.8)},"-=1");
			introTimeline.to(frame3_animate, 0.5, {rotationX:-30, rotationY:50,  x:-240, y:140, opacity:1, ease: Power2.easeIn},"+=1.2");
			introTimeline.to(text3d, 0.5, {opacity:0, y:200, ease: Power2.easeIn},"-=0.55");
			...
			introTimeline.to(dollar1, 0.2, {opacity:0, ease: Power2.easeOut},"-=2.8");
			
			//dollar2
			introTimeline.to(dollar2, 0.2, {opacity:1, ease: Power2.easeOut},"-=2.8");
			introTimeline.to(dollar2, 3, {x: 0, y:-250, opacity:1, ease: Power2.easeOut},"-=2.7");
			...
			introTimeline.to(dollar2, 0.2, {opacity:0, ease: Power2.easeOut},"-=2.8");
			
			//dollar3
			introTimeline.to(dollar3, 0.2, {opacity:1, ease: Power2.easeOut},"-=2.8");
			introTimeline.to(dollar3, 3, {x: 0, y:-250, opacity:1, ease: Power2.easeOut},"-=2.7");
			...
			introTimeline.to(dollar3, 0.2, {opacity:0, ease: Power2.easeOut},"-=2.8");

			//scene 4 - heat pump
	 		introTimeline.from(frame4_animate, 0.9, {rotationX:50, rotationY:-100, x:325, y:-130, opacity:1, ease: Elastic.easeOut.config(0.6, 0.5)}, "-=1.2");	
