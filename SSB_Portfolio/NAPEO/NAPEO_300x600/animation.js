...
.to(".main-copy-1", {duration: 0.8, scale:1, ease: "back.out(0.8)", opacity:1, stagger: 0.1},"-=10")
.to(".main-copy-2", {duration: 0.8, scale:1, ease: "back.out(0.8)", opacity:1, stagger: 0.1},"-=7")

//Scene 02
.to(".main-copy-3", {duration: 0.8, scale:0.5, ease: "back.out(0.8)", opacity:1, stagger: 0.1 },"-=1.5")
.to("#logo_symbol", {duration: 0.4, scale:0.5, ease: "back.out(0.8)", opacity:1, force3D:false},"-=1.4")
