...
.to("#txt3_d", {duration: 0.5, ease: "power3.out", opacity:1},"-=2.5")
.to("#text03_wrapper",{duration: 0.5, top: -72, ease:"sine.out", opacity:1, force3D:false},"-=1")
.to("#cta", {duration: 0.5, scale:0.5, ease: "back.out(0.8)", opacity:1, force3D:false},"-=0.7")
