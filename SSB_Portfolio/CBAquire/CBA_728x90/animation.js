...
tl
//Scene 01
.to("#bank", {duration: 0.7, left:6, ease: "back.out(0.3)", opacity:1, yoyo:true, repeat:1, repeatDelay:2.4, force3D:false},"-=0")
.to("#txt1_a", {duration: 0.55, scale:0.5, ease: "back.out(1)", opacity:1},"-=3.3")
.to("#txt1_b", {duration: 0.55, top:37, ease: "back.out(1)", opacity:1},"-=2.8")
.to("#txt1_c", {duration: 0.55, top:41, ease: "back.out(1)", opacity:1},"-=2.8")
.to("#txt1_a", {duration: 0.55, scale:0.5, top: -100, ease:"sine.in", opacity:0},"-=0.5")
.to("#text01_wrapper",{duration: 0.55, top: 150, ease:"sine.in", opacity:0, force3D:false},"-=0.6")
