...
tl
//Scene 01
.to("#txt1_a", {duration: 0.5, top:5, ease: "back.out(0.8)", opacity:1},"+=0")
.to("#txt1_b", {duration: 0.5, top:1, ease: "back.out(0.8)", opacity:1},"-=0.5")

.to(".puzzle-01", {duration: 0.5, scale:0.5, ease: "power3.out", opacity:1, stagger: 0.1, repeat:1, repeatDelay:0.8, yoyo:true},"+=1")
...
//Scene 02
.to("#txt2_a", {duration: 0.5, top:6, ease: "back.out(0.8)", opacity:1},"-=2")
.to("#txt2_b", {duration: 0.5, top:-33, ease: "back.out(0.8)", opacity:1},"-=2")
.to("#blue",{duration: 0.4, ease:"power3.out", opacity:1},"-=0.3")
.to("#text02_wrapper",{duration: 0.5, left:-300, ease:"power3.in", opacity:1},"-=0.5")

//Scene 03
.to("#photo_wrapper",{duration: 0.4, ease:"power3.out", opacity:1},"-=0.2")
...
.to("#logo_symbol", {duration: 0.4, scale:0.5, ease: "back.out(0.8)", opacity:1, force3D:false},"-=3.9")
