...
.to("#txt1_b", {duration: 0.5, top:2, ease: "back.out(0.8)", opacity:1},"-=0.5")
...
//Scene 02
.to("#txt2_a", {duration: 0.5, top:1, ease: "back.out(0.8)", opacity:1},"-=2")
.to("#txt2_b", {duration: 0.5, top:-14, ease: "back.out(0.8)", opacity:1},"-=2")
