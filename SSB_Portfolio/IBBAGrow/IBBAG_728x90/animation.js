...
tl
//Scene 01
.to("#txt1_a", {duration: 0.65, top: 25, ease: "back.out(0.9)", opacity:1},"-=0")
.to("#txt1_b", {duration: 0.65, top: 24, ease: "back.out(0.9)", opacity:1},"-=0.5")
.to("#txt1_c", {duration: 0.65, top: 23, ease: "back.out(0.9)", opacity:1},"-=0.5")
...
//Scene 02
.to(".main-copy-2", {duration: 0.7, scale:0.5, ease: "back.out(0.8)", opacity:1, stagger: 0.2 },"-=0.3")
