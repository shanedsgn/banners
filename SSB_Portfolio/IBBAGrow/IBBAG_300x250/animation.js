...
tl
//Scene 01
.to("#txt1_a", {duration: 0.65, left: -44, ease: "back.out(0.9)", opacity:1},"-=0")
.to("#txt1_b", {duration: 0.65, left: -28, ease: "back.out(0.9)", opacity:1},"-=0.5")
.to("#txt1_c", {duration: 0.65, left: -28, ease: "back.out(0.9)", opacity:1},"-=0.5")
