...
tl
//Scene 01
.to("#txt1_a", {duration: 0.65, top: 16, ease: "back.out(0.9)", opacity:1},"-=0")
.to("#txt1_b", {duration: 0.65, top: 15, ease: "back.out(0.9)", opacity:1},"-=0.5")
.to("#txt1_c", {duration: 0.65, top: 15, ease: "back.out(0.9)", opacity:1},"-=0.5")
...
.to("#text01_wrapper",{duration: 0.6, top: 100, ease:"sine.in", opacity:0, force3D:false},"+=1")
.to("#grow_wrapper",{duration: 0.6, top: -200, ease:"sine.in", opacity:0, force3D:false},"-=0.6")

//Scene 02
.to(".main-copy-2", {duration: 0.7, scale:0.5, ease: "back.out(0.8)", opacity:1, stagger: 0.2 },"-=0.4")
.to("#cta", {duration: 0.5, scale:0.5, ease: "back.out(0.8)", opacity:1, force3D:false},"-=0.2")
.to("#logo_main",{duration: 0.5, ease:"power3.out", opacity:1 },"-=0")
.to("#text02_wrapper",{duration: 0.5, ease:"sine.out", opacity:0, force3D:false},"+=0.6")
