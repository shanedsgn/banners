...
.to("#txt1_b", {duration: 0.55, top:132, ease: "back.out(1)", opacity:1},"-=0")
.to("#txt1_c", {duration: 0.55, top:154, ease: "back.out(1)", opacity:1},"-=0.5")
...
.to("#txt2_b", {duration: 0.55, top:132, ease: "back.out(1)", opacity:1},"-=0")
.to("#txt2_c", {duration: 0.55, top:154, ease: "back.out(1)", opacity:1},"-=0.5")
...
.to(".main-copy-1", {duration: 0.7, scale:0.5, ease: "back.out(0.8)", opacity:1, stagger: 0.1 },"-=0.4")
