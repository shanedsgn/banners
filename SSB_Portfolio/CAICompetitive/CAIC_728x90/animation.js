...
.to("#txt1_b", {duration: 0.55, top:32, ease: "back.out(1)", opacity:1},"-=0")
.to("#txt1_c", {duration: 0.55, left:3, ease: "back.out(1)", opacity:1},"-=0")
...
.to("#txt2_b", {duration: 0.55, top:32, ease: "back.out(1)", opacity:1},"-=0")
.to("#txt2_c", {duration: 0.55, left:7, ease: "back.out(1)", opacity:1},"-=0")
