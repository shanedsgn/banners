...
.to("#txt1_b", {duration: 0.55, top:15, ease: "back.out(1)", opacity:1},"-=0")
.to("#txt1_c", {duration: 0.55, left:-1, ease: "back.out(1)", opacity:1},"-=0")
...
.to("#txt2_b", {duration: 0.55, top:14, ease: "back.out(1)", opacity:1},"-=0")
.to("#txt2_c", {duration: 0.55, left:1, ease: "back.out(1)", opacity:1},"-=0")
