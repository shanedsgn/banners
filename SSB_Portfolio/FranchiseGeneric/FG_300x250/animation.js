...
.to("#logo_symbol", {duration: 0.4, scale:0.5, ease: "back.out(0.8)", opacity:1, force3D:false},"-=0.2")
...
.to("#txt3_d", {duration: 0.5, ease: "power3.out", opacity:1},"+=0.1")
.to("#text03_wrapper",{duration: 0.5, top: -72, ease:"sine.out", opacity:1, force3D:false},"+=0.5")
