...
.to("#hero",{duration: 0.8, left: -17, ease:"power3.out"},"+=1")
.to(".txt",{duration: 0.5, left: -23, top: -5, ease:"power3.out"},"-=0.8")
.to("#logo",{duration: 0.5, top: -5, ease:"power3.out"},"-=0.7")
...
.to("#disclaimer",{duration: 0.4, ease:"power2.out", opacity: 1},"-=0.7")
;
